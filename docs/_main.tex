...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(mod1}\SpecialCharTok{$}\NormalTok{lme, }\AttributeTok{form =} \FunctionTok{resid}\NormalTok{(., }\AttributeTok{type =} \StringTok{"pearson"}\NormalTok{) }\SpecialCharTok{\textasciitilde{}} \FunctionTok{fitted}\NormalTok{(.) }\SpecialCharTok{|}\NormalTok{ scanner)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(mod2}\SpecialCharTok{$}\NormalTok{lme, }\AttributeTok{form =} \FunctionTok{resid}\NormalTok{(., }\AttributeTok{type =} \StringTok{"pearson"}\NormalTok{) }\SpecialCharTok{\textasciitilde{}} \FunctionTok{fitted}\NormalTok{(.) }\SpecialCharTok{|}\NormalTok{ scanner)}
\end{Highlighting}
\end{Shaded}
